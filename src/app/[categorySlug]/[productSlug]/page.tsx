...
import { ProductCardCompact } from "@/components/general/ProductCardCompact";
  ...
  useEffect(() => {
    const loadProduct = async () => {
      try {
        ...
        const productData =
          await productService.getProductBySlugFromApi(productSlug);
        if (!productData) {
    ...
    <div className="min-h-screen bg-background">
      <main className="pt-6">
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-6">
          ...
          {/* Product Details Sections - COMMENTED OUT FOR LATER USE */}
          {/*
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
          ...
          */}
          ...
          {/* Recently Viewed - COMMENTED OUT FOR LATER USE */}
          {/*
